...
<div id="post" style="MARGIN-RIGHT: auto; MARGIN-LEFT: auto; ">
    ...
    <form action="SavePost.php?action=edit&id=<?php echo($arrays['PostId']);?>" method="post" enctype="multipart/form-data" id="addlog" name="addlog">

        <label for="title" id="title_label">输入文章标题</label>
        <input type="text" maxlength="200" name="title" id="title" value="<?php echo($arrays['PostTitle']);?>"/>
        <textarea id="content" name="content" style="width:845px; height:460px;">
            <?php echo($arrays['PostContent']);?>
        </textarea>
        ...
        <table align="center" style="width: 70%">
            <tr>
                ...
                <td>
                    <input value="<?php echo($arrays['HeadTitile']);?>" type="text" style="width:100%;height:3%;left: 10%"  name="HeadTitle" id="HeadTitle"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" value="<?php echo($arrays['HeadDescription']);?>" style="width:100%;height:3%"  name="HeadDescription" id="HeadDescription"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" value="<?php echo($arrays['HeadKeywords']);?>"style="width:100%;height:3%"  name="HeadKeywords" id="HeadKeywords"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" value="<?php echo($arrays['HeadAuthor']);?>" style="width:100%;height:3%"  name="HeadAuthor" id="HeadAuthor"/>
                </td>
            </tr>
        </table>
        <div id="post_button">
