...
function checkform(){
	var a = $.trim($("#HeadAuthor").val());
    var d = $.trim($("#HeadDescription").val());
    var ht = $.trim($("#HeadTitle").val());
    var k = $.trim($("#HeadKeywords").val());
